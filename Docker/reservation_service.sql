...
CREATE TABLE `archivos` (
  ...
  CONSTRAINT `archivos_ibfk_1` FOREIGN KEY (`reserva_id`) REFERENCES `reservation` (`id_reservation`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reservation` VALUES (1,7,1,'RES-932FD38A',1,1400000.00,'2026-07-02 00:00:00','2026-07-06 00:00:00','pendiente',0,'2026-07-01',NULL,'2026-07-01 17:46:15',NULL,'',1,'Caribe de Ensueño','Cartagena','Doble','Ninguna');
...
INSERT INTO `reservation_emergency_contact` VALUES (1,1,'Stefania','Compañera','6565798978',NULL);
...
-- Dump completed on 2026-07-01 13:18:09
