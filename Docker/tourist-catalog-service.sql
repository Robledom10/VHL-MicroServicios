...
INSERT INTO `itinerarie` VALUES (1,1,'Llegada a Cartagena.',1),(2,2,'Tour panorámico por Cartagena.',1),(3,3,'Excursión a Islas del Rosario.',1),(4,4,'Tarde libre.',1),(5,5,'Desayuno y traslado al aeropuerto.',1);
...
INSERT INTO `package` VALUES (1,'Caribe de Ensueño','Vive una experiencia inolvidable entre las coloridas calles de Cartagena y las aguas cristalinas de las Islas del Rosario. Disfruta de paisajes paradisíacos, playas de arena blanca, cultura, historia y momentos únicos en el corazón del Caribe colombiano.','Cartagena',5,1200000.00,34,'Calarcá, Quindío','Bus de turismo','https://res.cloudinary.com/dqcviyp18/image/upload/v1782336811/vhl/packages/y3ravrgofn2ezb0u1sal.jpg','https://res.cloudinary.com/dqcviyp18/image/upload/v1782336811/vhl/packages/k0m0sqzekyjyh9hyhzid.jpg',1);
...
INSERT INTO `package_cancellation_policy` VALUES (1,'Cancelación gratuita hasta 5 días antes del viaje.'),(1,'50% de reembolso si cancela 48 horas antes.'),(1,'No hay devolución el mismo día del viaje.');
...
INSERT INTO `package_destination` VALUES (1,'Cartagena'),(1,'Islas del Rosario');
...
INSERT INTO `package_exclusion` VALUES (1,'Gastos personales'),(1,'Bebidas alcohólicas'),(1,'Compras personales');
...
INSERT INTO `package_inclusion` VALUES (1,'Transporte terrestre ida y regreso'),(1,'Hospedaje en hotel 3 estrellas'),(1,'Alimentación (desayuno y cena)'),(1,'Tours turísticos guiados');
...
INSERT INTO `package_requirement` VALUES (1,'Cédula de ciudadanía obligatoria.'),(1,'Edad mínima: 5 años.'),(1,'Pago completo antes del viaje.');
...
INSERT INTO `package_transport_type` VALUES (1,'Bus de turismo');
...
-- Dump completed on 2026-06-25  0:48:25
