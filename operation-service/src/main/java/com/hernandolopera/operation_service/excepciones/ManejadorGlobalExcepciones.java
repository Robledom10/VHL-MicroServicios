...
import com.hernandolopera.operation_service.dto.DatosOperacion.RespuestaErrorApi;
...
public class ManejadorGlobalExcepciones {
    ...
    public ResponseEntity<RespuestaErrorApi> manejarReglaNegocio(
        ExcepcionReglaNegocio excepcion,
        HttpServletRequest solicitud
    ) {
    ...
    public ResponseEntity<RespuestaErrorApi> manejarArgumento(
        IllegalArgumentException excepcion,
        HttpServletRequest solicitud
    ) {
        return construir(HttpStatus.BAD_REQUEST, excepcion.getMessage(), solicitud, Map.of());
    }
    ...
    private ResponseEntity<RespuestaErrorApi> construir(
        ...
        return ResponseEntity.status(codigo).body(new RespuestaErrorApi(
            LocalDateTime.now(),
            codigo.value(),
            codigo.getReasonPhrase(),
            mensaje,
